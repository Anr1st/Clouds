...
![2](https://github.com/Anr1st/Clouds/tree/main/clouds_lab1/clouds.jpg)  
...
![1](https://github.com/Anr1st/Clouds/tree/main/clouds_lab1/cat1.jpg)  

## Практическая часть
1. Скачиваем все файлы из папки "AWS";
2. Работу выполняем в "LAB1.csv", каждый отдельный файл открывается на отдельном листе, подписанном номером файла из папки;
...
![3](https://github.com/Anr1st/Clouds/tree/main/clouds_lab1/cat2.jpg)
